...
class MySTNodeVisitor(Visitor):
    ...
    def push_myst_node(self, node):
        self.parent_result["children"].append(node)

    @contextlib.contextmanager
    def enter_myst_node(self, node):
    ...
    def visit_comment(self, node):
        with self.enter_myst_node(
            {"type": "comment", "value": str(node.children[0])},  # TODO: totext
        ):
            yield SkipChildren
    ...
    def visit_reference(self, node):
        if node.get("refid"):
            return self.enter_myst_node(
                {"type": "link", "url": f"#{node['refid']}", "children": []}
            )
        elif node.get("refuri"):
            return self.enter_myst_node(
                {"type": "link", "url": node["refuri"], "children": []}
            )
        else:
            raise

    def visit_topic(self, node):
        return self.enter_myst_node({"type": "admonition", "children": []})

    def visit_problematic(self, node):
        return self.enter_myst_node(
            {"type": "span", "class": "problematic", "children": []}
        )
    ...
    def visit_enumerated_list(self, node):
        return self.enter_myst_node({"type": "list", "ordered": True, "children": []})
    ...
    def visit_rubric(self, node):
        return self.enter_myst_node({"type": "blockQuote", "children": []})

    def visit_transition(self, node):
        return self.enter_myst_node({"type": "thematicBreak"})

    def visit_list_item(self, node):
        return self.enter_myst_node({"type": "listItem", "children": []})

    def visit_emphasis(self, node):
        return self.enter_myst_node({"type": "emphasis", "children": []})

    def visit_strong(self, node):
        return self.enter_myst_node({"type": "strong", "children": []})
    ...
    def visit_sidebar(self, node):
        return self.enter_myst_node(
            {"type": "aside", "kind": "sidebar", "children": []}
        )
    ...
    def visit_field(self, node):
        return self.enter_myst_node({"type": "fieldListItem", "children": []})

    def visit_field_name(self, node):
        return self.enter_myst_node({"type": "fieldName", "children": []})

    def visit_field_body(self, node):
        return self.enter_myst_node({"type": "fieldDescription", "children": []})

    def visit_classifier(self, node):
        return SkipChildren

    def visit_definition_list(self, node):
        return self.enter_myst_node({"type": "definitionList", "children": []})

    def visit_definition(self, node):
        return self.enter_myst_node({"type": "definitionDescription", "children": []})

    def visit_term(self, node):
        return self.enter_myst_node({"type": "definitionTerm", "children": []})
    ...
    def visit_table(self, node):
        return self.enter_myst_node({"type": "table", "children": []})
    ...
    def visit_row(self, node):
        return self.enter_myst_node({"type": "tableRow", "children": []})

    def visit_entry(self, node):
        return self.enter_myst_node({"type": "tableCell", "children": []})

    def visit_footnote(self, node):
        return self.enter_myst_node({"type": "footnoteDefinition", "children": []})
    ...
    def visit_caption(self, node):
        return self.enter_myst_node(
            {"type": "caption", "kind": "figure", "children": []}
        )

    def visit_figure(self, node):
        return self.enter_myst_node(
            {"type": "container", "kind": "figure", "children": []}
        )
    ...
    def visit_attribution(self, node):
        return self.enter_myst_node({"type": "caption", "children": []})
...
for name in (
    ...
    def visitor(self, node, name=name):
        return self.enter_myst_node(
            {"type": "admonition", "kind": name, "children": []}
        )
